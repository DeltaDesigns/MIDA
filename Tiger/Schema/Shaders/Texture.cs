...
public class Texture : TigerReferenceFile<STextureHeader>
{
    ...
    public void SavetoFile(string savePath, int index = 0)
    {
        ...
        SavetoFile(savePath, simg, GetDimension());
    }
...
public struct STextureHeader
{
    ...
    [SchemaField(0x04, TigerStrategy.MARATHON)]
    public uint Format;
    ...
    [SchemaField(0x22, TigerStrategy.MARATHON)]
    public ushort Width;
    ...
    [SchemaField(0x3C, TigerStrategy.MARATHON)]
